...
public interface Bezier2f {
    ...
    /**
     * Interpolates between all points of the bezier curve using the given interpolation factor {@code t}. Then stores the result in {@code dest}.
    ...
    /**
     * Interpolates the derivative of the bezier curve using the given interpolation factor {@code t}. Then stores the result in {@code dest}.
     * @param t interpolation factor between [0-1] range
     * @param dest will hold the result 
     * @return {@code dest}
     */
    ...
    /**
     * Calculates the derivative vector and normalizes it using the given interpolation factor {@code t}. Then stores the result in {@code dest}.
     * @param t interpolation factor between [0-1] range
     * @param dest will hold the result 
     * @return {@code dest}
     */
    ...
    /**
     * Calculates the tangent vector and rotates it +90 Degrees so that if the tangent was equal to {@code (1, 0)}, the result stored in {@code dest} would be {@code (0, 1)}.
     * @param t interpolation factor between [0-1] range
     * @param dest will hold the result 
     * @return {@code dest}
     */
